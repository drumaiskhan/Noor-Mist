...
export default function MediaLibrary() {
  ...
  const deleteMutation = useMutation({
    ...
    onSuccess: () => { queryClient.invalidateQueries(['media']); toast.success('Deleted'); setPreviewItem(null); },
  });

  const bulkDeleteMutation = useMutation({
    mutationFn: mediaAPI.bulkDelete,
    onSuccess: () => { queryClient.invalidateQueries(['media']); setSelected(new Set()); toast.success('Deleted selected items'); },
  });
