...
export default function App() {
  const fetchActiveTheme = useThemeStore((s) => s.fetchActiveTheme);
  const checkAuth = useAuthStore((s) => s.checkAuth);
    ...
    settingsAPI.get()
      .then(({ data }) => applySiteIcon(data.settings || {}))
      .catch(() => {});
  }, []);
        ...
        <Suspense fallback={<Loader />}>
          <Routes>
            ...
            <Route element={<MainLayout />}>
              ...
              <Route path="/privacy" element={<PolicyPage pageKey="privacy" defaultHeading="Privacy Policy" />} />
              <Route path="/refund" element={<PolicyPage pageKey="refund" defaultHeading="Refund Policy" />} />
              <Route path="/shipping-policy" element={<PolicyPage pageKey="shipping_policy" defaultHeading="Shipping Policy" />} />
              <Route path="/terms" element={<PolicyPage pageKey="terms" defaultHeading="Terms & Conditions" />} />
              <Route path="/collections" element={<Collections />} />
              <Route path="*" element={<NotFound />} />
            </Route>

            {/* Admin Login — standalone, no site layout */}
            <Route path="/admin/login" element={<AdminLogin />} />

            {/* Admin Routes — protected, separate from public site */}
            <Route
              path="/admin"
