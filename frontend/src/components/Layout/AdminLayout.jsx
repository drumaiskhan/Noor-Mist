...
import {
  HiHome, HiCube, HiCollection, HiTag, HiClipboardList, HiUsers, HiStar,
  HiTicket, HiArchive, HiColorSwatch, HiTemplate, HiSearchCircle, HiCog,
  HiChartBar, HiMenu, HiX, HiLogout, HiPencil, HiMail, HiCreditCard,
  HiLibrary, HiPhotograph, HiDocumentText,
} from 'react-icons/hi';
...
const sidebarLinks = [
  ...
  { path: '/admin/collections', label: 'Collections', icon: HiTag },
  ...
  { path: '/admin/payment-settings', label: 'Payments', icon: HiCreditCard },
    ...
    <div className="min-h-screen bg-noir flex">
      ...
      <aside
        className={`
          ...
          bg-noir-light border-r border-gold/10 z-50
      ...
      >
        <div className="flex flex-col h-full">
          ...
          <div className="border-t border-gold/10 p-4">
              ...
              <div>
                {editingName ? (
                  <input
                    ...
                    className="bg-transparent border-b border-gold text-white"
                  />
                ) : (
            ...
            <button onClick={handleLogout} className="flex items-center gap-3 text-danger">
              <HiLogout />
              Logout
            </button>
          </div>
      ...
      <div className="flex-1">
        <header className="h-16 border-b border-gold/10 flex items-center px-4">
